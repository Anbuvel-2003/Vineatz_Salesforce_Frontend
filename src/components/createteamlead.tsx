...
const Addteamlead = () => {
  ...
  const handleSubmit = async (values: FormValues) => {
    ...
    const createapi = await authApi?.Createteamlead({
      Name: values.name,
      Email: values.email,
      Mobilenumber: values.contact,
      Alternative_Mobilenumber: values.emergencyContact,
      Address: values.address,
      Bike_Number: values.bikeNumber,
     Driving_License_Number: values.licenseNumber,

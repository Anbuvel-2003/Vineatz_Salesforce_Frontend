...
function ProspectlistApplication() {
    ...
    return (
        // /top section
        <section >
            <div className="bg-[#F4FFFE] px-5 h-auto w-full">
                ...
                <div className="overflow-x-auto  px-16">
                    <table className="min-w-full">
                        ...
                        <tbody className=" rounded-[60px] space-y-3 drop-shadow-md ">
                            {details.map((item) => (
                                <tr key={item.id} className="grid grid-cols-[repeat(7,1fr)_auto] bg-white items-center px-6 py-5  hover:bg-[#F8F9FF] transition rounded-[15px] border-gray-100">
                                    <td>{item.appid}</td>
                                    <td>{item.name}</td>
                                    <td>{item.clientid}</td>
